...
class _ExploreState extends State<Explore> {
  ...
  final List<Event> allEvents = [
    Event(
      ...
      description:
          "Join us for an amazing night of live music featuring top artists from around the world. Food and drinks available.",
    ),
    Event(
      "Art Exhibition",
      "City Gallery",
      ...
      description:
          "Experience contemporary art from emerging artists. Special guided tours available.",
    ),
    Event(
      "Food Festival",
      "Downtown Square",
      ...
      description:
          "Taste cuisines from around the world. Over 50 food vendors, live cooking demonstrations, and more!",
    ),
    Event(
      "Tech Conference",
      "Convention Center",
      ...
      description:
          "Learn about the latest technologies and network with industry leaders. Workshops and panel discussions included.",
    ),
    Event(
      "Dance Workshop",
      "Dance Studio",
      ...
      description:
          "Learn various dance styles from professional instructors. All skill levels welcome.",
    ),
    Event(
      "Startup Meetup",
      "Innovation Hub",
      ...
      description:
          "Connect with fellow entrepreneurs and investors. Pitch your ideas and get valuable feedback.",
    ),
    Event(
      "Street Food Fair",
      "City Center",
      ...
      description:
          "Experience the best street food vendors in the city. Live music and entertainment throughout the day.",
    ),
    Event(
      "Jazz Night",
      "Blue Note Club",
      ...
      description:
          "Enjoy an evening of smooth jazz with renowned musicians. Dinner and drinks available.",
    ),
    Event(
      "Sports Tournament",
      "City Stadium",
      ...
      description:
          "Watch teams compete in various sports. Food vendors and entertainment available throughout the event.",
    ),
  ];
